...
<form class="form w-100" action="{{ route('register') }}" method="POST" onsubmit="btnSubmit.disabled=true; btnSubmit.innerText ='Processing'; return true;">
    ...
    <div class="card-body">
        ...
        <div class="text-start mb-10">
            <h1 class="text-dark mb-3 fs-3x" data-kt-translate="sign-in-title">Sign Up <small class="fs-3">as Student</small></h1>
        ...
        <div class="fv-row mb-8">
            <input type="text" placeholder="Kode Undangan" name="referral_code" class="form-control form-control-solid @error('referral_code') is-invalid @enderror"/>
            @error('referral_code')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <p class="form-text text-muted">
                Biarkan kosong jika anda peserta reguler
            </p>
        </div>
